...
column_names = ["aoi_cart", "aoi_list", "aoi_main_shelf", "aoi_other_object", "hr", "hrv", "head_stillness",
...
def correlation_matrix():
    ...
    plt.xticks(ticks=np.arange(len(column_names)) + 0.5, labels=column_names_pretty, rotation=30, ha="center", fontweight='bold')
