...
def n2_back_speed_accuracy_plot():
    ...
    hr_ratio = [2.898446599828, 7.612309689955509, 8.87761617097111, 15.676080589967029, 3.697598062162072,
                4.529166613939404, 10.765099249447136, 12.817840314420362, 10.220098779271435, 53.82780235911642,
                11.856086010495309, 17.945457800143537, 11.81345868381989, 9.414911018971967, 6.591877076073444,
                10.405475605944146, 31.14721485411141, 14.417208165769955, 22.613195565813147, 27.198569513080596,
    ...
    #     colors]
    legend_elements = [
        mlines.Line2D([], [], marker='o', linestyle='None', color='blue', label='< median', markersize=10),
    ...
    ax.legend(handles=legend_elements, title='Percentage Increase Heart Rate vs Baseline', loc='best')
    plt.show()
